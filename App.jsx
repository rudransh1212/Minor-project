...
const indianDistricts = {
    ...
    "features": [
        // Simplified GeoJSON for a few districts for demonstration
...
function App() {
    ...
    const Legend = () => (
        <div className="absolute bottom-4 right-4 bg-gray-800 bg-opacity-80 p-3 rounded-lg text-white text-sm shadow-lg z-[1000]">
            ...
            <div className="flex items-center mb-1"><div className="w-4 h-4 rounded-full mr-2" style={{backgroundColor: getSalinityColor(1.5)}}></div>{'1.0 - 2.0 (Moderate)'}</div>
            ...
            <div className="flex items-center"><div className="w-4 h-4 rounded-full mr-2" style={{backgroundColor: getSalinityColor(3.5)}}></div>{'> 3.0 (Very High)'}</div>
        </div>
    );
                ...
                <div className="flex-grow flex flex-col space-y-8">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <label className={`flex items-center p-3 rounded-lg cursor-pointer transition-all ${scenario === 'rcp45' ? 'bg-cyan-500 text-white' : 'bg-gray-700 hover:bg-gray-600'}`}>
                            ...
                            <label className={`flex items-center p-3 rounded-lg cursor-pointer transition-all ${scenario === 'rcp85' ? 'bg-cyan-500 text-white' : 'bg-gray-700 hover:bg-gray-600'}`}>
